from odescalar import runge_kuttta3, runge_kuttta4
import numpy as np
...
if __name__ == '__main__':
    ...
    t_values_rkh3, y_values_rkh3 = runge_kuttta3(f, y0, t0, tk, h)
    ...
    t_values_rk4, y_values_rk4 = runge_kuttta4(f, y0, t0, tk, h)
